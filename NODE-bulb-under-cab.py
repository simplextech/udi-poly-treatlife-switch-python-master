...
DEVICEID = "ebe097c0407da32084kvtr"   # "ebe097c0407da32084kvtr" #"ebfc16d57ed374932cjqfk"
DEVICEIP = "192.168.1.148"    #"192.168.1.140"                        #"192.168.1.142"
DEVICEKEY = "cb02297ceb692149" #"cb02297ceb692149" #"805217605357161b"
DEVICEVERS = "3.3"
...
# Test Modes
print('\nTesting Bulb Modes') ##turns bulb off
print('    White')
d.set_mode('white')
time.sleep(2)
print('    Colour')
